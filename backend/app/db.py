...
class AnalysisTask(Base):
    ...
    progress_current_frame: Mapped[int | None] = mapped_column(Integer)
    progress_total_frames: Mapped[int | None] = mapped_column(Integer)
    progress_detected_frames: Mapped[int | None] = mapped_column(Integer)
    progress_peak_reba: Mapped[float | None] = mapped_column(Float)
